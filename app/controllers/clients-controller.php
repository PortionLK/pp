<?php
    ...
    function addClient()
    {
        ...
        //echo $_REQUEST['captcha_value'];
        $clients->setValues($_REQUEST);

        if ($_REQUEST['captcha_value'] != "") {
            ...
            $clients->setClientPassword($password);
            $clients_id = $clients->newClients();
            ...
            if ($clients_id != 0) {
                ...
                $mailClass->clientRegistration($clients->clientTitle(), $clients->clientFirstName(), $clients->clientLastName(), $clients->clientUsername(), $clients->clientEmail(), $password);
    ...
    // function ExisPasswordEdit(){
    // $clients = new Clients();
    // $clients->setClientEmail($_REQUEST['client_email']);
    // $clients->setClientId($_REQUEST['client_id']);
    // $details =  $clients->isPasswordExsistsEdit();
    // echo $details;
    // }
