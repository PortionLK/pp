<?php
	...
	$addedRooms = $addedRooms->where('hotel_id', '=', $hotel_id)
		...
		->select('rooms.*', 'room_types.name as room_type_name')->get();
?>
...
<div class="row">
	<div class="form-group col-xs-12">
		<a href="<?php echo DOMAIN; ?>dashboard/add-hotel/step-04"><button type="button" class="pull-right btn-lg btn btn-primary">Save & Continue <i class="fa fa-arrow-circle-right"></i></button></a>
	</div>
</div>
<?php } ?>