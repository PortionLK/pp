	...
	<fieldset>
		...
		<div class="row">
			<div class="form-group col-md-12 col-sm-12 col-xs-12">
				...
				<div class="radio">
					<label><input type="radio" name="info[is_transport]" value="1" checked="true"> Yes</label>
					</div>
					<div class="radio">
					<label><input type="radio" name="info[is_transport]" value="0"> No</label>
				</div>
			</div>
			...
			<div class="form-group col-md-6 col-sm-6 col-xs-12">
				...
				<input class="form-control" type="text" name="info[ransport_fee]" placeholder="__.__">
			...
			<div class="form-group col-md-6 col-sm-6 col-xs-12">
				...
				<div class="input-group">
				<input name="info[distance]" type="text" class="form-control" placeholder="__.__"> <div class="input-group-addon"><strong>km</strong></div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-6 col-sm-6 col-xs-12">
				...
				<input name="info[check_in]" type="text" class="form-control" placeholder="__:__">
			</div>
			<div class="form-group col-md-6 col-sm-6 col-xs-12">
				<label class="title-label">Check-Out(hh:mm)</label>
				<input name="info[check_out]" type="text" class="form-control" placeholder="__:__">
			</div>
		</div>
		<hr/>
