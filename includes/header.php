<nav class="navbar mainNav navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo HTTP_PATH; ?>"><img src="<?php echo HTTP_PATH; ?>images/roomista_logo.png" class=""/></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navigation-bar">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user text-success"></i> <?php echo $_SESSION['user']['first_name']; ?> <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="<?php echo HTTP_PATH;?>dashboard" class="name"><i class="glyphicon glyphicon-user"></i> <?php echo $_SESSION['user']['first_name'] . ' ' . $_SESSION['user']['last_name']; ?><br><small>View Profile</small></a></li>
				<li class="divider"></li>
				<li><a href="<?php echo HTTP_PATH;?>dashboard"><i class="fa fa-tachometer"></i> Dashboard</a></li>
				<li class="divider"></li>
				<li>
					<form action="<?php echo HTTP_PATH; ?>logout" method="post">
		...
		<?php }else{ ?>
        	<li><a href="<?php echo HTTP_PATH;?>register/">Register</a></li>
          <li class="dropdown">
                ...
                <li>
                  ...
                  <input type="hidden" name="csrf" value="e29a7dc6b05461dfb19942e4331666b9">
                            ...
                            <div class="bottom text-center">
                                New here ? <a href="<?php echo HTTP_PATH; ?>register/"><b>Join Us</b></a>
                            </div>
                     </div>
                </li>
            </ul>
